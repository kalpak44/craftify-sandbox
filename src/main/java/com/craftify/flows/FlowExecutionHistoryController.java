...
public class FlowExecutionHistoryController {
    ...
    public FlowExecutionHistoryController(FlowExecutionHistoryService flowExecutionHistoryService, AuthUtil authUtil) {
    ...
    public ResponseEntity<Page<FlowExecutionHistory>> getExecutionHistoryForUser(
        ...
        Page<FlowExecutionHistory> history = flowExecutionHistoryService.getExecutionHistoryForUser(userId, pageable);
    ...
    public ResponseEntity<Page<FlowExecutionHistory>> getExecutionHistoryForFlow(
        ...
        var userId = authUtil.getCurrentUserId();
        try {
            Page<FlowExecutionHistory> history = flowExecutionHistoryService.getExecutionHistoryForFlow(flowId, userId, pageable);
            return ResponseEntity.ok(history);
