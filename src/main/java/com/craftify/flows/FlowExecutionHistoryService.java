...
public class FlowExecutionHistoryService {
    ...
    public FlowExecutionHistoryService(FlowExecutionHistoryRepository flowExecutionHistoryRepository) {
    ...
    public FlowExecutionHistory createExecutionHistory(String flowId, String userId, String flowName, String flowConfiguration) {
        FlowExecutionHistory history = new FlowExecutionHistory(flowId, userId, flowName, flowConfiguration);
        return flowExecutionHistoryRepository.save(history);
    }
    ...
    public void updateExecutionStatus(String historyId, String status, String errorMessage, String flowConfiguration) {
        FlowExecutionHistory history = flowExecutionHistoryRepository.findById(historyId)
                .orElseThrow(() -> new ResourceNotFoundException("Execution history not found"));
    ...
    public Page<FlowExecutionHistory> getExecutionHistoryForFlow(String flowId, String userId, Pageable pageable) {
        return flowExecutionHistoryRepository.findByFlowIdAndUserIdOrderByCreatedAtDesc(flowId, userId, pageable);
    }
