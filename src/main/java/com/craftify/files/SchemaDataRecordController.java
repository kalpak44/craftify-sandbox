...
public class SchemaDataRecordController {
  ...
  public ResponseEntity<SchemaDataRecord> createRecord(
      @PathVariable String schemaId, @RequestBody Map<String, Object> data) {
  ...
  public ResponseEntity<List<Map<String, Object>>> getRecordsForTable(
  ...
  public ResponseEntity<SchemaDataRecord> getRecord(@PathVariable String recordId) {
    String userId = authUtil.getCurrentUserId();
    return schemaDataRecordService
  ...
  public ResponseEntity<SchemaDataRecord> updateRecord(
      @PathVariable String recordId, @RequestBody Map<String, Object> data) {
    String userId = authUtil.getCurrentUserId();
    try {
