...
/**
 * Configuration class for setting up the {@link ChatClient} bean with default tools. Integrates
 * custom AI tools into the Spring AI chat client.
 */
@Configuration
public class ChatClientConfig {
  ...
  public ChatClient chatClient(JobRunnerTool tool, ChatModel chatModel) {
    return ChatClient.builder(chatModel).defaultTools(tool).build();
  }
}
