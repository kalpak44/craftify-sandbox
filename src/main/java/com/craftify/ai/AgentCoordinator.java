...
/**
 * Coordinates interactions between the user and the AI-powered {@link ChatClient}. Streams response
 * content back to the caller chunk by chunk and signals completion.
 */
@Component
