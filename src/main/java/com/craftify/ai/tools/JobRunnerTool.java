...
/**
 * Tool component for executing full Python scripts in a Kubernetes job.
 * Submits, monitors, retrieves logs, and performs cleanup post-execution.
 */
@Component
public class JobRunnerTool {
     ...
     */
    @Tool(name = "runPythonCode", description = """
    ...
    private boolean isErrorLog(String log) {
        ...
        return lower.contains("traceback") || lower.contains("syntaxerror")
