...
/**
 * Configuration class for setting up the Fabric8 Kubernetes client.
 * Loads properties prefixed with "kubernetes" from the application configuration.
 */
@Configuration
...
public class Fabric8Config {
    ...
    /**
     * Creates and provides a configured {@link KubernetesClient} bean using Fabric8.
     * Automatically closes the client when the Spring context is shut down.
     *
