...
@Tag(name = "Function", description = "Operations for function registration")
public class FunctionController {
  ...
  public FunctionController(
      ...
      RegistrationJobStore jobStore,
      SimpMessagingTemplate messagingTemplate,
      AuthentificationService authentificationService,
      FunctionBuilderConfig functionBuilderConfig,
  ...
  private void simulateRegistration(
      RegistrationJob job, RegisterFunctionDto req, String currentUserId) {
    ...
    try {
      ...
      try (Git repo =
        ...
        send(
            job,
            "Repo successful cloned, use commit #%s".formatted(lastCommitHash),
            "in-progress",
            null);
