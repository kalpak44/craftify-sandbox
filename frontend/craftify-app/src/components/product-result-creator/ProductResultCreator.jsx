...
const ProductResultCreator = ({addProductResult, onClose, productResult}) => {
    ...
    useEffect(() => {
        if (productResult) {
            ...
            setMeasurements(
                Object.entries(productResult.measurements || {}).map(([key, {value, unit}]) => ({
                    key,
                    value,
                    unit,
                }))
            ...
            setAvailability(
                Object.entries(productResult.availability || {}).map(([key, {value, unit}]) => ({
                    key,
                    value,
                    unit,
                }))
    ...
    return (
        <>
            ...
            <div className="p-4 border rounded-lg shadow-md bg-gray-800">
                ...
                {(mode === "CREATE_NEW" || mode === "REPLACE_EXISTING") && (
                    <>
